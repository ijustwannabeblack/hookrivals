    ...
    local types = {}; do
        ...
        function types:Toggle(name, options, callback)
            ...
            local check = library:Create('Frame', {
                ...
                library:Create('TextLabel', {
                    ...
                    library:Create('TextButton', {
                        ...
                        -- If we have a keybind, shift the checkmark slightly left to make room
                        Position = UDim2.new(1, keybind and -50 or -25, 0, 4);
                        TextColor3 = library.options.textcolor;
            ...
            if keybind then
                ...
                local nm = shortNames[keybind.Name] or keybind.Name
                local kbBtn = library:Create('TextButton', {
                    ...
                    BorderColor3 = library.options.bordercolor;
                    BorderSizePixel = 1;
                    Parent = check:FindFirstChild(name)
                })
                ...
                kbBtn.MouseButton1Click:Connect(function()
                    ...
                    local bname = (a.UserInputType ~= Enum.UserInputType.Keyboard and a.UserInputType.Name or a.KeyCode.Name)
                    kbBtn.Text = shortNames[bname] or bname
                    keybindcallback(a.UserInputType ~= Enum.UserInputType.Keyboard and a.UserInputType or a.KeyCode)
                    task.wait(0.1)
